...
public class ZbModTabs {
	...
	public static void load() {
		Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, TAB_ZBTAB, FabricItemGroup.builder().title(Component.translatable("item_group." + ZbMod.MODID + ".zbtab")).icon(() -> new ItemStack(ZbModItems.ZB_ITEM)).build());
	}
}
